...
class Tent_Blip2(nn.Module):
    ...
    def forward(self, data_loader, task_cfg, tta_cfg):
        ...
        for _ in range(self.steps):
            outputs = forward_and_adapt_blip2(self, self.optimizer, data_loader, task_cfg, tta_cfg.wo_rerank)
...
def forward_and_adapt_blip2(tta_model, optimizer, dataloader, task_cfg, wo_rerank):
    ...
    # score_i2t, score_t2i = model.compute_sim_matrix(dataloader, task_cfg)
