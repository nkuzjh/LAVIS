...
log_files=(
    ...
    "ret_coco_eval_itm_adapt_i2t_exp11.0.3.2.out"
    "ret_coco_eval_itm_adapt_i2t_exp11.0.3.3.out"
    "ret_coco_eval_itm_adapt_i2t_exp11.0.3.4.out"
...
args_files=(
    ...
    "lavis/projects/blip2/eval/ret_coco_eval_itm_adapt_i2t_exp11.0.3.2.yaml"
    "lavis/projects/blip2/eval/ret_coco_eval_itm_adapt_i2t_exp11.0.3.3.yaml"
    "lavis/projects/blip2/eval/ret_coco_eval_itm_adapt_i2t_exp11.0.3.4.yaml"
